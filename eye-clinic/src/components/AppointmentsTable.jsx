        ...
        <div className="h-full overflow-y-auto rounded-lg">
          <table className="w-full text-left">
            <thead className="border-b border-gray-200 sticky top-0 bg-white">
              <tr>
                <th className="py-3 px-4 font-semibold text-sm text-gray-600">Time</th>
                <th className="py-3 px-4 font-semibold text-sm text-gray-600">Patient Name</th>
              ...
              {filteredAppointments.map((appointment, index) => {
                ...
                return (
                  <tr key={index} className="border-b border-gray-200 hover:bg-gray-50 transition-colors">
                    <td className="py-4 px-4 text-gray-900">{appointment.time}</td>
                    <td className="py-4 px-4 font-medium text-gray-900">{appointment.patientName}</td>
