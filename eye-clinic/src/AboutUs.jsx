  ...
  return (
    <div className="aboutus-container">
      ...
      <header className="aboutus-header">
        <div className="logo">
          <img src={logoImg} alt="Clinic Logo" className="logo-img" />
      ...
      <section className="hero" id="home">
        ...
        <div
          ...
          style={{
            backgroundImage:
              'url("https://lh3.googleusercontent.com/aida-public/AB6AXuCC42nE5hEkS4G0bf04D9DRX8hI0P9NxfvVUoHLNxIdvZLeNuhqyLh6yWulTtFKUHq7nmYYldLH3q3K1bh8tB5fr_6FKHHbHFnkh0q0TpvUbEQMWA73V8eWhGTpAAlEt1taYDuHlpPOjC_41LoomTFlaimgLP-XDl_Bc4bn_A4LRWj6UadVrYJYeE05pi38JKDELoPrw7qcbQPlHCgEeAntXkUhSmBBqnnQPC2G0--6n5Tk6NfDBrWffRkyesmVXfY00xdwiCpP98I")',
          }}
        ></div>
      </section>
      ...
      <main className="main-content" id="aboutus">
        ...
        {/* Right Side (Doctor + Working Hours) */}
